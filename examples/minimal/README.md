...
| <a name="output_diagnostic_setting_names"></a> [diagnostic\_setting\_names](#output\_diagnostic\_setting\_names) | The diagnostic setting names (diag-<resource> when auto-derived). |
<!-- END_TF_DOCS -->
